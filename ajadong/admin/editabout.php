...
$id=$_GET['id'];
	...
	{
	//echo vinod; exit;
	  if($_FILES['imageAbout']['name']<>'')
	  {
	  
	  	$ifileext=explode('.',$_FILES['imageAbout']['name']);
			...
			$query=mysql_query("SELECT * FROM `about` WHERE `aboutId`='$id'");
			...
			move_uploaded_file($_FILES['imageAbout']['tmp_name'], $itarget2);
			$target_file = $itarget2.basename($_FILES["imageAbout"]["name"]);
			$res=mysql_query("UPDATE `about` SET `imageAbout`='".$image_file."',`descriptionAbout`='".addslashes($_POST['descriptionAbout'])."' WHERE aboutId='$id'");
	  ...
	  else if($_POST['descriptionAbout']<>'')
	  {
	  
	 $res=mysql_query("UPDATE `about` SET `descriptionAbout`='".addslashes($_POST['descriptionAbout'])."' WHERE `aboutId`='$id'");
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="box">
		  ...
		  <?php
				$prices_query=mysql_query("select * from  about where aboutId='$id'");
          ...
          <div class="box-body">
            <form role="form" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="file" id="imageAbout" name="imageAbout"  onChange="readURL(this);" >
                  </div>
				   <div class="controls">
				<div><img  id="image" height="200px" width="200px" src="images/<?php echo $key->imageAbout;?>">						    </div>
						  
                    <div class="form-group">
                      <label for="exampleInputPassword1">Description</label><br/>
                      <textarea name="descriptionAbout" id="editor1" placeholder="Enter something"  style="width:50%;height:150px"><?php echo $key->descriptionAbout;?></textarea>
					  <script type="text/javascript">
...
//]]>
                ...
                <div class="box-footer">
                  ...
                  &nbsp;&nbsp;
                  <a href="about"><input type="button" class="btn btn-default" value="Cancel"></a>                </div>
              </form>
          </div><!-- /.box-body -->
          <!-- /.box-footer-->
        </div><!-- /.box -->
