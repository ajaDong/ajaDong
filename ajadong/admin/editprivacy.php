...
$id=$_GET['id'];
	...
	{//print_r($_FILES);print_r($_POST);exit;
	  if($_POST['headingPrivacy']<>'' && $_POST['descriptionPrivacy']<>'')
	  {
mysql_query("UPDATE `privacyaucation` SET  `headingPrivacy`='".addslashes($_POST['headingPrivacy'])."',`descriptionPrivacy`='".addslashes($_POST['descriptionPrivacy'])."' WHERE `idPrivacy`='$id'");	  
    ...
    <div class="wrapper">
	  ...
	  <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
			  ...
			  <?php
				$prices_query=mysql_query("select * from privacyaucation where idPrivacy='$id'");
       ...
       <div class="form-group">
                      ...
                      <input type="text" class="form-control"  name="headingPrivacy"  style="width:50%" value="<?php echo $key->headingPrivacy;?>">
                    </div>
					
					<div class="form-group">
                      <label for="exampleInputEmail1">Description</label>
                      <textarea class="form-control" id="editor" name="descriptionPrivacy"  style="width:50%"><?php echo $key->descriptionPrivacy;?></textarea>
                    </div>
                  ...
                  &nbsp;&nbsp;
                   <a href="privacypolicy"><input type="button" class="btn btn-default" value="Cancel"></a>
                  </div>
                </form>
