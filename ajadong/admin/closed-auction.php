  ...
  <head>
	...
	<script>
		...
		if (x)
	    {
         ...
         $.ajax({type:'POST',url:'deleteclosed.php',data:{id:id},success:function(result){
		 if(result=='yes')
		 {
		 alert("Closed Auction has been deleted successfully");
		 $('#sessiondiv'+id).hide();
		 }else
		 {
		 alert("Invalid ");
        ...
        <section class="content">
          <div class="row">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php
							...
							$appQuery=mysql_query("SELECT * FROM `auction_product_details` where product_end_date<='$sdate' ORDER BY product_end_date DESC ");
            ...
            ?>-->
					 ...
					 <a href="eitclose-auction.php?id=<?php echo $appRes->product_id;?>"><button class="btn bg-purple margin"><i class="fa fa-edit"></i>Edit</button></a>
								<a href="javascript:void(0);" onClick="deleteclosed(<?php echo $appRes->product_id;?>);"><button class="btn btn-danger"><i class="fa fa-warning (alias)"></i>Delete</button></a>
