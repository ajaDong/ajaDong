...
$id=$_GET['id'];
//$updateComp=mysql_query("update useequipment set viewStatus='1' where useequipment_ID='$id'");
?>
<!DOCTYPE html>
<html>
  <head>
	  ...
	  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">View Equipment Product</li>
          </ol>
        </section>
		...
		<section class="content">
		  ...
		  <div class="box">
            <div class="box-header with-border">
			  ...
			  <?php
				$prices_query=mysql_query("select ue.*,e.equipmentname,c.first_name,c.last_name,ut.regiaterUserName from useequipment ue,equipment e,customer c,usertable ut where ue.equipment_ID=e.equipmentid and ue.customer_ID=c.customerId and ue.user_ID=ut.userID and ue.useequipment_ID='$id'");
			  ...
			  <form role="form" method="post" enctype="multipart/form-data">
			   ...
			   <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <?php echo $key->last_date;?>
                    </div>
					<div class="form-group">
                      <label for="exampleInputEmail1">Featured : </label>
                      <?php $featured=$key->status; if($featured==0){ echo "Notapproved";} else { echo "Approved";} ?>
                    </div>
				</div>

               <div class="box-footer">
                  
                   <a href="equipmentrequest.php"><input type="button" class="btn btn-default" value="back"></a>
                  </div>
