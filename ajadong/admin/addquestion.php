...
include('includes/db.php');
	...
	$res=mysql_query("INSERT INTO `question`(`question`) VALUES('".addslashes($_POST['question'])."')");
		}			  
		if($res)
		{
            ...
            <div class="box-body">
              <form role="form" method="post" enctype="multipart/form-data">
                  ...
                  <label for="exampleInputEmail1">Question</label>
                   <input type="text" name="question" class="form-control" placeholder="Enter something"  style="width:50%;">
