...
$id=$_GET['id'];
	...
	{//print_r($_FILES);print_r($_POST);exit;
	  ...
	  {
mysql_query("UPDATE `term_condition` SET  `heading`='".addslashes($_POST['heading'])."',`discription`='".addslashes($_POST['description'])."' WHERE `termid`='$id'");	  
	  ...
	  <div class="content-wrapper">
       ...
       Term and condition
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Edit Term and Condition </li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
			  ...
			  <?php
				$prices_query=mysql_query("select * from term_condition where termid='$id'");
       ...
       <div class="form-group">
					...
					<div class="form-group">
                      ...
                      <textarea class="form-control" id="editor" name="description"  style="width:50%"><?php echo $key->discription;?></textarea>
                    </div>
					
					<!--<div class="form-group">
                      <label for="exampleInputEmail1">Meta Title</label>
                      <input type="text" class="form-control"  name="aboutusMetatitle"  style="width:50%" value="<?php echo $key->aboutusMetatitle;?>">
                    </div>
    			    <div class="form-group">
                      <label for="exampleInputEmail1">Meta Description</label>
                      <textarea class="form-control" id="editor1" name="aboutusMetaDescription"  style="width:50%"><?php echo $key->aboutusMetaDescription;?></textarea>
                    </div>-->
                  ...
                  &nbsp;&nbsp;
                   <a href="termandcondition"><input type="button" class="btn btn-default" value="Cancel"></a>
                  </div>
                </form>
