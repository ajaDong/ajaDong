...
if(isset($_POST['submit']))
   ...
   if($_POST['product_name']<>'' && $_POST['product_reatil_price']<>'' && $_POST['product_base_price']<>'' && $_POST['product_category']<>'' && $_POST['product_description']<>'' && $_POST['product_manufacturer']<>'' && $_POST['product_start_date']<>'' && $_POST['product_end_date']<>'' && $_FILES['product_image']['name']<>'')
   {
            ...
            <div class="box-body">
              <form class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<div class="control-group">
  								...
  								<input type="text" class="form-control" style="width:50%" name="product_manufacturer" id="title">
  								</div>
								<div class="control-group">
  								<label class="control-label">Product Start Date</label><br/>
  								<input type="text" id="popupDatepicker1" class="form-control" style="width:50%" name="product_start_date" id="title" readonly>
  								</div>
								<div class="control-group">
  								<label class="control-label">Product End Date</label><br/>
  					<input type="text" id="popupDatepicker" class="form-control" style="width:50%" name="product_end_date" id="title" required readonly>
  								</div>
								<div class="control-group">
