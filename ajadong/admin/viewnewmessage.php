...
$id=$_GET['id'];
$update=mysql_query("UPDATE `mail_auction` SET `viewStatus`='1' WHERE `mailId`='$id'");
?>
<!DOCTYPE html>
<html>
  <head>
...
$appQuery=mysql_query("select ma.*,ut.regiaterUserName from mail_auction ma,usertable ut where ma.sendID=ut.userID and ma.mailId='$id'");
			  ...
			  <form role="form" method="post" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <?php echo $key->mailbcc;?>
                    </div>
					<div class="form-group">
                      <label for="exampleInputEmail1">Message :</label>
                      <?php echo $key->messege;?>
                    </div>
                  <div class="box-footer">
                   <a href="newinbox.php"><input type="button" class="btn btn-default" value="Back" style="background-color: #00CC33; color:#FFFFFF"></a>
                  </div>
                </form>
