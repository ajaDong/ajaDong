...
{
//print_r($_POST);exit;
if($_POST['user_country']=="newsletter"){
 $site='http://www.houseofbid.com/beta/';          
 $url=$_POST['userName'];
 $subject2 =$_POST['subject'];
 $message3 =$_POST['message'];   
 $headers2 .= "Content-type:text/html;charset=UTF-8" . "\r\n";
 $headers2 .= "From:".' '.$url;
 $nnquery=mysql_query("SELECT * FROM `stayupdate`");
 $no=1;
	while($nnres=mysql_fetch_object($nnquery))
	{
	$mail=$nnres->emailStay;
	mail($mail,$subject2,$message3,$headers2);
	$no++;
	}
          ...
          <div class="box">
			...
			<?php if(isset($msg)){echo $msg;}?>
              <form role="form" method="post" enctype="multipart/form-data" id="uploadForm">
					...
					<select name="user_country" id="user_country" class="form-control" style="width:50%;" required>
