...
$id=$_GET['id'];
 	if(isset($_POST['submit']))
	{
		...
		//echo "UPDATE `auction_product_details` SET `product_name`='".addslashes($_POST['product_name'])."',`product_image`='".$image_file."',`product_image1`='".$image_file1."',`product_image2`='".$image_file2."',`product_image3`='".$image_file3."',`product_image4`='".$image_file4."',`product_reatil_price`='".addslashes($_POST['product_reatil_price'])."',`product_base_price`='".addslashes($_POST['product_base_price'])."',`product_category`='".addslashes($_POST['product_category'])."',`product_description`='".addslashes($_POST['product_description'])."',`product_manufacturer`='".addslashes($_POST['product_manufacturer'])."',`product_start_date`='".addslashes($_POST['product_start_date'])."',`product_end_date`='".addslashes($_POST['product_end_date'])."' WHERE product_id='$id'";exit;
		
	    $res=mysql_query("UPDATE `auction_product_details` SET `product_name`='".addslashes($_POST['product_name'])."',`product_image`='".$image_file."',`product_image1`='".$image_file1."',`product_image2`='".$image_file2."',`product_image3`='".$image_file3."',`product_image4`='".$image_file4."',`product_reatil_price`='".addslashes($_POST['product_reatil_price'])."',`product_base_price`='".addslashes($_POST['product_base_price'])."',`product_category`='".addslashes($_POST['product_category'])."',`product_description`='".addslashes($_POST['product_description'])."',`product_manufacturer`='".addslashes($_POST['product_manufacturer'])."',`product_start_date`='".addslashes($_POST['product_start_date'])."',`product_end_date`='".addslashes($_POST['product_end_date'])."' WHERE product_id='$id'");
		}
					...
					<?php   }
					  ...
					  ?>
								...
								<div class="control-group">
  								...
  								<input type="text" id="popupDatepicker1"  class="form-control" readonly style="width:50%" name="product_start_date" value="<?php echo $key->product_start_date?>" id="title">
  								</div>
								<div class="control-group">
  								<label class="control-label">Product End Date</label><br/>
  								<input type="text" id="popupDatepicker"  class="form-control" readonly style="width:50%" name="product_end_date" id="title" value="<?php echo $key->product_end_date?>">
  								</div>
								<div class="control-group">
