	...
	{		
	  ...
	  {	  
		...
		mysql_query("UPDATE `auction_product_details` SET product_image4='".$image_file4."' WHERE product_id='$id'");
			...
			mysql_query("DELETE FROM `productbid` WHERE `productId`='$id'");
			mysql_query("DELETE FROM `autobid` WHERE `productId`='$id'");
    ...
    <div class="wrapper">
	  ...
	  <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Edit a Passed Auction
          </h1> 
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Edit a Live Auction</li>
          </ol>
        </section>
            ...
            <div class="box-body">
              <form class="form-horizontal" method="post" enctype="multipart/form-data">
					...
					<?php   }
					  ...
					  {
					  ?>
					  <option value="<?php echo $mediaRes1->brandName;?>" <?php if($catid1==$mediaRes1->brandName){?> selected="selected"<?php }?>><?php echo $mediaRes1->brandName;?></option>
					<?php   }
					  ...
					  ?>
						...
						<img id="blah5" style="height:200px;width:200px;" src="images/<?php echo $key->product_image4;?>"/>
                                ...
                                <a href="Passed-auction.php" class="btn btn-primary">Cancel</a>
                             	</div>
							</form>
            </div><!-- /.box-body -->
            <!-- /.box-footer-->
