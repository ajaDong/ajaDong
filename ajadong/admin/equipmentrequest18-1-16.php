              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php
							$appQuery=mysql_query("select ue.*,e.equipmentname,c.first_name,c.last_name,ut.regiaterUserName from useequipment ue,equipment e,customer c,usertable ut where ue.equipment_ID=e.equipmentid and ue.customer_ID=c.customerId and ue.user_ID=ut.userID");
...
<a class="btn btn-warning" href="equipmentrequest.php?id=<?php echo $appRes->useequipment_ID;?>&name=d" id="Disable">
            ...
            ?>
			    <a href="calendar.php?id=<?php echo $appRes->equipmentid;?>"><button class="btn btn-info"><i class="fa fa-eye"></i>View Calender</button></a>
