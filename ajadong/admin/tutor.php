  ...
  <head>
	...
	<script>
		...
		if (x)
	    {
		 ...
		 if(result=='yes')
		 {
		 alert("Tutor has been deleted successfully");
		 $('#sessiondiv'+id).hide();
		 }else
		 {
		 alert("Invalid ");
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
          <li><a href="addtutor.php">
<button class="btn bg-navy btn-flat margin" style="margin-top: -2%">Add a new Tutor</button></a></li>
        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php
							$appQuery=mysql_query("select t.*,u.universityName from tutorhighschool t,university u where t.universityID=u.universityId and type='tutor'");
                      ...
                      <tr id="sessiondiv<?php echo $appRes->tutorId;?>">
                       <td><?php echo $appRes->firstnameTutor;?></td>
						<td><?php echo $appRes->emailTutor;?></td>
						 ...
						 <td><?php echo $appRes->courseTutor;?></td>
            ...
            {
            ?>
           <a class="btn  btn-success" href="approvedsubject.php?id=<?php echo $appRes->tutorId;?>&name=e" id="Enable">
            ...
            ?>
						...
						<a href="viewtutor.php?id=<?php echo $appRes->tutorId;?>"><button class="btn btn-info"><i class="fa fa-eye"></i>View</button></a>
