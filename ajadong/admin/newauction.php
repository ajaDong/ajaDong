  ...
  <head>
	...
	<script>
		...
		if (x)
	    {
         ...
         $.ajax({type:'POST',url:'deleteauction.php',data:{id:id},success:function(result){
		 if(result=='yes')
		 {
...
<button class="btn bg-navy btn-flat margin" style="margin-top: -2%">Add a new Auction</button></a></li>
        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php
							$appQuery=mysql_query("select * from auction_product_details");
                      ...
                      <tr id="sessiondiv<?php echo $appRes->product_id;?>">
						...
						<!--<td><?php //echo $appRes->userLastName;?></td>-->
            ...
            {
            ?>
           <a class="btn  btn-success" href="newauction.php?id=<?php echo $appRes->product_id;?>&name=e" id="Enable">
            ...
            {
            ?>
            <a class="btn btn-warning" href="newauction.php?id=<?php echo $appRes->product_id;?>&name=d" id="Disable">
            ...
            ?>
					 ...
					 <a href="editauction.php?id=<?php echo $appRes->product_id;?>"><button class="btn bg-purple margin"><i class="fa fa-edit"></i>Edit</button></a>
