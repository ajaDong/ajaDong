...
include('includes/db.php');
	...
	$res=mysql_query("INSERT INTO `subjecthighschool`(`subjectName`,`universityID`,`subjectCode`,`Image`) VALUES('".addslashes($_POST['subjectName'])."','".addslashes($_POST['universityID'])."','".addslashes($_POST['subjectCode'])."','".$image_file."')");
		}			  
		if($res)
		{
          ...
          <div class="box">
            ...
            <div class="box-body">
              <form role="form" method="post" enctype="multipart/form-data">
                  ...
                  <select name="universityID" class="form-control" style="width:50%;" required>
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="subjectName" placeholder="Enter Course Name" style="width:50%">
                    </div>
					
					<div class="form-group">
                  <label for="exampleInputEmail1">Course Code</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="subjectCode" placeholder="Enter Subject Code" style="width:50%">
                    </div>
