...
$id=$_GET['id'];
	...
	{//print_r($_FILES);print_r($_POST);exit;
	  ...
	  {
mysql_query("UPDATE `how_its_work` SET `heading`='".addslashes($_POST['heading'])."',`description`='".addslashes($_POST['description'])."' WHERE `howid`='$id'");	  
	  ...
	  <div class="content-wrapper">
       ...
       How Its Work
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Edit How Its Work </li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
			  ...
			  <?php
				$prices_query=mysql_query("select * from how_its_work where howid='$id'");
       ...
       <div class="form-group">
					...
					<div class="form-group">
                      ...
                      <textarea class="form-control" id="editor" name="description"  style="width:50%"><?php echo $key->description;?></textarea>
                    </div>
                  ...
                  &nbsp;&nbsp;
                   <a href="howitswork"><input type="button" class="btn btn-default" value="Cancel"></a>
                  </div>
                </form>
