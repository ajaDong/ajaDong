              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php
							$appQuery=mysql_query("select ma.*,ut.regiaterUserName from mail_auction ma,usertable ut where receiveID='0' and ma.viewStatus='0' and ma.sendID=ut.userID");
                      ...
                      <tr id="sessiondiv<?php echo $appRes->mailId;?>">
                        <td><?php echo $appRes->regiaterUserName;?></td>
						 ...
						 <td><?php echo $appRes->messege;?></td>
                                 <td>   
						<a href="viewnewmessage.php?id=<?php echo $appRes->mailId;?>"><button class="btn btn-info"><i class="fa fa-eye"></i>View</button></a>
