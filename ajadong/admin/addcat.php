...
$id=$_GET['id'];
	...
	//print_r($_POST);exit;
	  if($_POST['title']<>'')
	  {
	 		...
	 		$res=mysql_query("INSERT INTO auction_category(`auction_catname`) VALUES('".addslashes($_POST['title'])."')");
		}			  
		if($res)
		{
          ...
          <div class="box-body">
            <form role="form" method="post" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" style="width:350px;" value="" required >                  </div>
					
                <div class="box-footer">
                  <input type="submit" class="btn btn-primary" value="Save" name="submit">
                  &nbsp;&nbsp;
                  <a href="category"><input type="button" class="btn btn-default" value="Cancel"></a>                </div>
              </form>
          </div><!-- /.box-body -->
          <!-- /.box-footer-->
        </div><!-- /.box -->
