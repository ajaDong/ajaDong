              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php
							$appQuery=mysql_query("select c.*,ut.regiaterUserName from customer c,usertable ut where c.userID=ut.userID and c.custStatus='0'");
...
<td><img  style="width:100px; height:100px;" src="../subadmin/images/<?php echo $appRes->image;?>"></td>
						...
						<a href="viewnewcustomer.php?id=<?php echo $appRes->customerId;?>"><button class="btn btn-info"><i class="fa fa-eye"></i>View</button></a>
