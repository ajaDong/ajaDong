...
$id=$_GET['id'];
 	if(isset($_POST['submit']))
	{
	  if($_POST['question']<>'')
	  {
	 $res=mysql_query("UPDATE `question` SET `question`='".addslashes($_POST['question'])."' WHERE questionId='$id'");
		}			  
		if($res)
		{
	  ...
	  <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box">
			...
			<?php
			$prices_query=mysql_query("select * from  question where questionId='$id'");
            ...
            <div class="box-body">
              <form role="form" method="post" enctype="multipart/form-data">
				  ...
				  <input type="text" name="question" class="form-control"  placeholder="Enter something"  style="width:50%;" value="<?php echo $key->question;?>">
...
//]]>
                  ...
                  &nbsp;&nbsp;
                   <a href="question"><input type="button" class="btn btn-default" value="Cancel"></a>
                  </div>
