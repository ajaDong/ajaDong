...
include('includes/db.php');
	...
	{ //print_r($_FILES); print_r($_POST);exit;
	  ...
	  if($_FILES['image']<>'' && $_POST['heading']<>'' && $_POST['text']<>'' )
	  {	
	...
	$res=mysql_query("INSERT INTO `slider`(`image`,`heading`,`text`) VALUES ('".$image_file."','".addslashes($_POST['heading'])."','".addslashes($_POST['text'])."')");
		}			  
		if($res)
		{
	  ...
	  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Add a slider</li>
          </ol>
        </section>
            ...
            <div class="box-body">
              <form role="form" method="post" enctype="multipart/form-data" id="form" onSubmit="return validateClick()">
                  <div class="box-body">
                    ...
                    <input type="file" id="image" name="image" onChange="readURL(this,1);" required>
                    </div>
					 <div class="controls">
					<img id="image1" style="height:200px;width:200px;"/> 
					</div>
					 <div class="form-group">
                    <label for="exampleInputFile">Heading</label> </br>
                    <input type="text" id="heading" class="form-control" style="width:50%;" name="heading"  required> </br>
					
					<label for="exampleInputFile">Text</label> </br>
					<input type="text" id="slider_text" class="form-control" style="width:50%;" name="text"  required>
                    </div> 
...
//]]>
			     ...
			     &nbsp;&nbsp;&nbsp;<a href="slider"><input type="button" class="btn btn-default" value="Cancel"></a>
                  </div>
                </form>
            </div><!-- /.box-body -->
            <!-- /.box-footer-->
