...
//echo "select count(*) as user from usertable";exit;
$userCount=mysql_query("select count(*) as user from usertable");
$userRes=mysql_fetch_object($userCount);
//echo $rr=$userRes->user;exit;
