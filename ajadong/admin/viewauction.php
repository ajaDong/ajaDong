	  ...
	  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">View Auction Product</li>
          </ol>
        </section>
			  ...
			  <form role="form" method="post" enctype="multipart/form-data">
			   ...
			   <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <img style="width: 150px; height: 150px;" src="images/<?php echo $key->product_image;?>"/>
                    </div>
					...
					<div class="form-group">
                      ...
                      <?php echo "$"." ".$key->product_reatil_price;?>
                    </div>
					
					<div class="form-group">
                      <label for="exampleInputEmail1">Base Price : </label>
                      <?php echo "$"." ".$key->product_base_price;?>
                    </div>
					
                    <div class="form-group">
                      <label for="exampleInputEmail1">Buy Now Price : </label>
                      <?php echo "$"." ".$key->	product_buynow_price;?>
                    </div>
					
					<div class="form-group">
                      <label for="exampleInputEmail1">Manufacturer : </label>
                      <?php echo $key->	product_manufacturer;?>
                    </div>
					
					<div class="form-group">
                      <label for="exampleInputEmail1">Warranty : </label>
                      <?php echo $key->product_warranty;?>
                    </div>
						
					<div class="form-group">
                      <label for="exampleInputEmail1">Description : </label>
                      <?php echo $key->product_description;?>
                    </div>
					
					<div class="form-group">
                      <label for="exampleInputEmail1">Featured : </label>
                      <?php $featured=$key->product_featured; if($featured==0){ echo "Featured";} else { echo "Not Featured";} ?>
                    </div>
				</div>

               <div class="box-footer">
                  
                   <a href="auction.php"><input type="button" class="btn btn-default" value="back"></a>
                  </div>
