...
$superadminquery=mysql_query("select * from admin where usernameAdmin='$name' and passwordAdmin='$pass'");
$subadminquery=mysql_query("select * from usertable where regiaterUserName='$name' and userPassword='$pass'");

if(mysql_num_rows($superadminquery)>0)
...
else if(mysql_num_rows($subadminquery)>0)
{
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              ...
              <button type="submit" class="btn btn-primary btn-block btn-flat" name="submit">Sign In</button>
				<?php //if(!isset($subadminquery && $superadminquery)){echo "Wrong User Name or Password";}?>
            </div><!-- /.col -->
