	  ...
	  <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
			<?php 
			$approvQuery=mysql_query("SELECT * FROM `tutorhighschool` WHERE tutorId='".$_GET['id']."'");
			$resapprove=mysql_fetch_object($approvQuery);
			$uni=$resapprove->universityID;
			$tut=$resapprove->tutorId;
			...
			?>
              <form role="form" method="post" enctype="multipart/form-data">
                  ...
                  <select name="universityID" class="form-control" onChange="getsubCat(this.value)" style="width:50%;" required>
					  ...
					  {
					  ?>
					  	<option  value="<?php echo $mediaRes2->universityId;?>" <?php if($mediaRes2->universityId==$uni){ echo 'selected="selected"';} ?>><?php echo $mediaRes2->universityName;?></option>
						<?php 
					  }
					  }
					  ?>
                  ...
                  <label for="exampleInputEmail1">Tutor Name</label>
						...
						<select name="tutorID" class="form-control"  style="width:50%;" required>
                        	<option value="">Select</option>
							 <?php 
					  $mediaQuery3=mysql_query("SELECT * FROM `tutorhighschool` WHERE tutorId='".$_GET['id']."'");
					  $mediaQueryno3=mysql_num_rows($mediaQuery3);
					  if($mediaQueryno3>0)
					  {
					  while($mediaRes3=mysql_fetch_object($mediaQuery3))
					  {
					  ?>
					  	<option  value="<?php echo $mediaRes3->tutorId;?>" <?php if($mediaRes3->tutorId==$tut){ echo 'selected="selected"';} ?>><?php echo $mediaRes3->firstnameTutor;?></option>
						<?php 
					  }
					  }
					  ?>
                  ...
                  <input type="text" class="form-control" value="<?php echo $resapprove->courseTutor;?>" id="exampleInputEmail1" name="subjectName" placeholder="Enter Course Name" style="width:50%" required>
                    </div>
