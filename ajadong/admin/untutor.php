...
<button class="btn bg-navy btn-flat margin" style="margin-top: -2%">Add a new Employer</button></a></li>-->
        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php
							$appQuery=mysql_query("select t.*,u.universityName from tutorhighschool t,university u where t.universityID=u.universityId and t.statustutlogin='0'");
            ...
            {
            ?>
           <a class="btn  btn-success" href="untutor.php?id=<?php echo $appRes->tutorId;?>&name=e" id="Enable">
            ...
            {
            ?>
            <a class="btn btn-warning" href="untutor.php?id=<?php echo $appRes->tutorId;?>&name=d" id="Disable">
