	  ...
	  <div class="content-wrapper">
        ...
        View Employe Detail
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">View Employe Detail</li>
          </ol>
        </section>
            ...
            <div class="box-header with-border">
			  ...
			  <form role="form" method="post" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
                      ...
                      <img name="image" style="width:200px; height:200px;" src="../subadmin/images/<?php echo $key->userImage;?>">
                    </div>
       				<div class="form-group">
					
                      <label for="exampleInputEmail1">Full Name :</label>
                      <?php echo $key->userName;?>&nbsp;<?php echo $key->userLastName;?>
                    </div>
					<div class="form-group">
