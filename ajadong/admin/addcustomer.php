...
include_once('includes/db.php');
	...
	$insertQuery=mysql_query("INSERT INTO `customer`(`userID`, `first_name`, `last_name`, `emailId`, `phoneNumber`, `address`,`image`,`city`, `country`, `zipcode`, `fax`) VALUES ('admin','".addslashes($_POST['first_name'])."','".addslashes($_POST['last_name'])."','".addslashes($_POST['emailId'])."','".addslashes($_POST['phoneNumber'])."','".addslashes($_POST['address'])."','".$image_file."','".addslashes($_POST['city'])."','".addslashes($_POST['country'])."','".addslashes($_POST['zipcode'])."','".addslashes($_POST['fax'])."')");
			}	
			if($insertQuery>0)
			{
    ...
    <div class="wrapper">
	  ...
	  <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Add an Event/Trade Show
          </h1>
          <ol class="breadcrumb">
            <li><a href="index"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Add an Event/Trade Show</li>
          </ol>
        </section>
			...
			<?php if(isset($msg)){echo $msg;}?>
              <form role="form" method="post" enctype="multipart/form-data" id="uploadForm">
                      ...
                      <label for="exampleInputPassword1">First name<span>*</span></label><br/>
					   <input type="text" class="form-control"  name="first_name" style="width:50%;"   placeholder=" Enter Your First Name"required>
					  </div>
					  
					  <div class="form-group">
                      <label for="exampleInputPassword1">Last name</label><br/>
					 <input type="text" class="form-control" id="userLastName"  name="last_name" style="width:50%;"  placeholder=" Enter Your Last Name">
                      </div>
					  
					  
		  <div class="form-group">
			<label for="exampleInputPassword1">email id<span>*</span></label><br>
			<input name="emailId" type="email" class="form-control" placeholder="Enter your Email Id" style="width:50%;"  id="emailTutor" value="" onBlur="emailvalidate11(this.value)" onFocus="if (this.value != ' ') {this.value = '';}"  required><img src="images/wrong.jpg" title="Email-Id alrady exist." id="msgem" class="emailmsg" style="display:none;height:20px;width:20px"/><img src="images/correct.png" id="msgem1" class="emailmsg" style="display:none;height:20px;width:20px"/>
		  </div>
		  
					<div class="form-group">
				<label for="exampleInputPassword1">Phone</label><br>
			<input type="text"  id="phoneNumber"  class="form-control" placeholder="Enter your phone number"style="width:50%;" name="phoneNumber" onBlur="mobilevalidate(this.value)" onFocus="if (this.value != ' ') {this.value = '';}" required><img src="images/wrong.jpg" title="Phone number worng." id="mw" class="emailmsg" style="display:none;height:20px;width:20px"/><img src="images/correct.png" id="mc" class="emailmsg" style="display:none;height:20px;width:20px"/>
					 </div>
                <div class="form-group">
					<label for="exampleInputPassword1">City</label>
					<input type="text" class="form-control" placeholder="Enter your City name"name="city" id="cityUser" style="width:50%;" />
					</div>
  <div class="form-group">
    <label for="exampleInputPassword1">Address</label>
    <textarea class="form-control" rows="3" name="address" style="width:50%;" id="addressUser"></textarea>
  </div>
...
document.write("<option value=\""+states[hi]+"\">"+states[hi]+"</option>");
					...
					<input type="text" class="form-control" placeholder="Enter your zipcode here" name="zipcode"  style="width:50%;" />
					</div>
					<div class="form-group">
					<label for="exampleInputPassword1">Fax</label>
					<input type="text" class="form-control" placeholder="Enter your fax number" name="fax" style="width:50%;" />
					</div>
