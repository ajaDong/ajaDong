...
if($_FILES['userImage']['name']<>'')
	  { 
            $ifileext=explode('.',$_FILES['userImage']['name']);
			$ifileext1=$ifileext[count($ifileext)-1];
			$image_file=time().rand(1111,9999).'.'.$ifileext1;
			$itarget2 = "images/";
			$itarget2 = $itarget2.$image_file;
			move_uploaded_file($_FILES['userImage']['tmp_name'], $itarget2);
			$target_file = $itarget2.basename($_FILES["userImage"]["name"]);
					
$insertQuery=mysql_query("INSERT INTO `usertable`(`userName`,`userLastName`,`userEmail`,`regiaterUserName`,`userPassword`,`userTelephone`,`userImage`) VALUES ('".addslashes($_POST['userName'])."','".addslashes($_POST['userLastName'])."','".addslashes($_POST['userEmail'])."','".addslashes($_POST['regiaterUserName'])."','".addslashes($_POST['userPassword'])."','".addslashes($_POST['userTelephone'])."','".$image_file."')" );	
			}	
			if($insertQuery>0)
			{
	  ...
	  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Add an Employer </li>
        ...
        <section class="content">
		  ...
		  <div class="form-group">
			...
			<label for="exampleInputPassword1">Employe Name<span>*</span></label><br>
			...
			<input type="text"  class="form-control" id="telephoneUser" placeholder="Please enter the  telephone number" value="" style="width:50%;" name="userTelephone" onBlur="mobilevalidate(this.value)" onFocus="if (this.value != ' ') {this.value = '';}" required><img src="images/wrong.jpg" title="Phone number worng." id="mw" class="emailmsg" style="display:none;height:20px;width:20px"/><img src="images/correct.png" id="mc" class="emailmsg" style="display:none;height:20px;width:20px"/>
						...
						<div class="form-group">
							  <label for="control-label">Employe Image</label>
								<input type="file" name="userImage" id="userImage" onChange="readURL(this);" required>
