	...
	if(isset($_POST['submit']))
{
 if($_FILES['logoImage']['name']<>'')
   ...
   if($ifileext1=='jpg' or $ifileext1=='jpeg' or $ifileext1=='png')
   {
	...
	//$image_file=time().rand(1111,9999).'.'.$ifileext1;
	$image_file=AjarinDongBroLogo.'.'.$ifileext1;
	//echo $image_file;exit;
   $itarget2 = "images/";
   $itarget2 = $itarget2.$image_file;
   $query=mysql_query("SELECT * FROM `logo` WHERE `logoId`='$id'");
   ...
   $res=mysql_query("UPDATE `logo` SET `logoImage`='".$image_file."' WHERE `logoid`='$id'");
  }     
  if($res)
  {
	  ...
	  <div class="content-wrapper">
        ...
        Edit a Logo Image
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Edit Logo Image</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
			  ...
			  <?php
				$prices_query=mysql_query("select * from  logo where logoid='$id'");
       ...
       <div class="form-group">
                      ...
                      <input type="file" id="logoImage" name="logoImage"  style="width:50%" onChange="readURL(this);">
                    </div>
					<div class="controls">
							  	 <div><img  id="blah" height="200px" width="200px" src="images/<?php echo $key->logoImage;?>">
							  </div>
							  </div>
                  ...
                  &nbsp;&nbsp;
                   <a href="logo"><input type="button" class="btn btn-default" value="Cancel"></a>
                  </div>
                </form>
