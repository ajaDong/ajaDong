...
{ 
	  ...
	  if($_FILES['heading']['name']<>'')
	  {	 	
	  	$ifileext=explode('.',$_FILES['heading']['name']);
		...
		if($ifileext1=='jpg' or $ifileext1=='jpeg' or $ifileext1=='png')
		{
			...
			$query=mysql_query("SELECT * FROM `tips` WHERE `tip_id`='$id'");
			...
			move_uploaded_file($_FILES['heading']['tmp_name'], $itarget2);
			$target_file = $itarget2.basename($_FILES["heading"]["name"]);
		//echo "UPDATE `slider` SET `image`='".$image_file."',`heading`='".$_POST['heading']."',`text`='".$_POST['text']."' WHERE slider_id='$id'";exit;
			$res=mysql_query("UPDATE `tips` SET `heading`='".$image_file."',`description`='".$_POST['description']."' WHERE tip_id='$id'");
	  ...
	  {	 	
			...
			$res=mysql_query("UPDATE `tips` SET `description`='".$_POST['description']."' WHERE tip_id='$id'");
			$msg= '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">X</button><strong>Well done!</strong> Succesfully Saved</div>';
		}
	  else{
	  ...
	  <div class="content-wrapper">
       ...
       Sponsor Banner
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Edit Sponsor Banner </li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
			  ...
			  <?php
				$prices_query=mysql_query("select * from  tips where tip_id='$id'");
       ...
       <div class="form-group">
                      ...
                      <input type="text" class="form-control"  name="description"  style="width:50%" value="<?php echo $key->description;?>">
                    </div>
					
					<div class="form-group">
                    <label for="exampleInputFile">Sponsor Image :</label>
                    <input type="file" id="image1" name="heading"  onChange="readURL(this);" >
                  </div>
					<div><img  id="image" height="200px" width="200px" src="images/<?php echo $key->heading;?>">	<br><br></div>
                  ...
                  &nbsp;&nbsp;
                   <a href="tips"><input type="button" class="btn btn-default" value="Cancel"></a>
                  </div>
                </form>
