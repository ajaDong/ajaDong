...
if($_POST['chapterName']<>'' && $_POST['subjectID']<>'' && $_POST['shortOrder']<>'' && $_FILES['system']['name']<>'' && $_FILES['system']['size']>0)

		{
			...
			$res=mysql_query("INSERT INTO `courseVideo`(`uiversityID`,`userID`,`courseID`,`chapterID`, `video`, `videoType`,`priceStatus`,`pdfupload`) VALUES('".$ui."','".$_SESSION['userid']."','".addslashes($_POST['subjectID'])."','$cID','".$v_video."','".$vfileext1."','".addslashes($_POST['priceStatus'])."','".$image_file2."')");
}else {

$res=mysql_query("INSERT INTO `courseVideo`(`uiversityID`,`userID`,`courseID`,`chapterID`, `video`, `videoType`,`priceStatus`,`pdfupload`) VALUES('".$ui."','".$_SESSION['userid']."','".addslashes($_POST['subjectID'])."','$cID','".$v_video."','".$vfileext1."','0','".$image_file2."')");
}
			if($res){
          ...
          <div class="user-detail-bg grey-bg-wrapper">
              ...
              <ul class="user-detail-nav nav nav-tabs" role="tablist">
               <!-- <li role="presentation" class="active col-xs-6"><a href="#daftar-pelajaran" aria-controls="home" role="tab" data-toggle="tab"><h4>Create Chapter</h4></a></li>-->
                <li role="presentation" class="active col-xs-6"><a href="#profile-setting" aria-controls="profile" role="tab" data-toggle="tab"><h4>CREATE CHAPTER</h4></a></li>
              </ul>
...
<div class="col-lg-12">
                  ...
                  <input type="submit" class="go-red-button"  name="addV" value="Submit" />
                  </div>
