<header class="navbar navbar-default navbar-fixed-top">
	  ...
	  <?php if($_SESSION['userid']==''){ ?>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <!--<div class="mobile-visibility-logo logo-right-navbar"><img src="images/AjarinDongBroLogo.png"></div>-->

          <li><a href="course-index.php"><span class="lnr lnr-pencil"></span>Course</a></li>

          <li><a href="login.php"><span class="lnr lnr-user"></span>Sign In</a></li>
