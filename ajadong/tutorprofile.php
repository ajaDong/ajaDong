			 ...
			 <div class="col-lg-2 col-md-offset-10 text-right"><br>
              ...
              <div class="user-detail-content tab-content">
                <div role="tabpanel" class="tab-pane active daftar-pelajaran" id="daftar-pelajaran">
				  ...
				  if($subjectCount>0)
					{
					 	$ressubject=mysql_fetch_object($subjectQuery);
					
				  ?>
                  <div class="daftar-pelajaran-content">
                   <?php echo $ressubject->subjectCode;?> - <?php echo $ressubject->subjectName;?>
                   <div class="text-right"><a href="allchaptershow.php"><button class="go-red-button" style="width:14%; background-color:#FFF; color:#000; border:none;">See Chapter</button></a></div>
                ...
                <div role="tabpanel" class="tab-pane profile-setting" id="profile-setting">
				 ...
				 <?php if($resTut->pictureTutor==''){ ?>
				  ...
				  <div class="form-group">
                    ...
                    <select name="courseTutor[]" class="form-control" multiple="multiple" disabled="disabled"  required>
                  ...
                  <div class="new-email">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" value="<?php echo $resTut->emailTutor;?>" id="exampleInputEmail1" readonly >
                    </div>
                    <div class="go-red-button">
                      <a>Not Changes</a>
                    </div>
