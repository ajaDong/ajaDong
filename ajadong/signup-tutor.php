...
$res=mysql_query("INSERT INTO `tutorhighschool`(`firstnameTutor`, `emailTutor`, `passwordTutor`,`universityID`, `profileTutor`, `courseTutor`, `degreeTutor`, `courseScoreTutor`,`type`) VALUES ('".addslashes($_POST['firstnameTutor'])."','".addslashes($_POST['emailTutor'])."','".addslashes($_POST['passwordTutor'])."','".addslashes($_POST['universityID'])."','".addslashes($_POST['profileTutor'])."','$arr','".addslashes($_POST['degreeTutor'])."','".addslashes($_POST['courseScoreTutor'])."','tutor')");
$uid=mysql_insert_id();
...
$msg='<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">X</button><strong>Well done!</strong> your registration is successful, please wait for team Ajarin Dong Bro to review your details and they will email you as soon the review is finished.</div>';
}
else
{
...
<html lang="en">
  ...
  <head>
    ...
    <script type="application/javascript">
		...
		function userName()
		{
			var uName=document.getElementById('firstnameTutor').value;
		 	if(uName=="" || isLetter(uName)==null)
			{
				document.getElementById('firstnameTutor').value='';
				document.getElementById('firstnameTutor').style.borderColor="red";
			}
			else
			{
				document.getElementById('firstnameTutor').style.borderColor="#fbc34b";	
			}
		}
      ...
      <div class="content-inside row col-md-12">
        ...
        <div class="col-md-8 form-custom">
          ...
          <div class="input-group">
            ...
            <input type="text" class="sandeep" pattern="[A-Za-z ]+" id="firstnameTutor" name="firstnameTutor" placeholder="Name" onKeyUp="userName();" required>
          ...
          <div class="input-group">
            ...
            <input type="password" class="sandeep" title="Password Min . 8 characters , one large, one number" name="passwordTutor" id="passworduser" placeholder="Password Min . 8 characters , one large, one number" onBlur="passvalidate(this.value)">
          ...
          <div class="input-group">
			...
			<select name="universityID" class="sandeep" onChange="getsubCat(this.value)" required>
		  ...
		  <div class="input-group">
			...
			<!--<select class="sandeep" name="courseTutor[]" multiple="multiple" id="subcategory" required>
                        	<option value="">Course</option>
							
                        </select>-->
						 <input type="text" class="sandeep"  name="courseTutor" placeholder="Course" required>
