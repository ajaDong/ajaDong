          ...
          <div class="user-detail-bg grey-bg-wrapper">
            <div>
              ...
              <ul class="user-detail-nav nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="col-xs-6"><a href="#profile-setting" aria-controls="profile" role="tab" data-toggle="tab"><h4>Add Video</h4></a></li>
              </ul>
		  ...
		  ?>
			...
			<select name="subjectID"  class="form-control" style="width:50%;" required>
                      ...
                      <label for="exampleInputPassword1">Chapter Number<span>*</span></label><br/>
					   ...
					   <input type="text" pattern="[1-9]+"  class="form-control" id="shortOrder" name="shortOrder" style="width:50%;"   placeholder=" Chapter Number ."required><br/>

					  </div>

                     <div class="box-footer">

                    <input type="submit" class="go-red-button"  id="btnSubmit" value="Submit" name="addC"><br/>
                  </div>
