...
if($_POST['courseID']<>'' && $_POST['chapterID']<>''  && $_FILES['system']['name']<>'' && $_FILES['system']['size']>0)

		{
			...
			$res=mysql_query("INSERT INTO `courseVideo`(`uiversityID`,`userID`,`courseID`,`chapterID`, `video`, `videoType`,`priceStatus`,`pdfupload`) VALUES('".$ui."','".$_SESSION['userid']."','".addslashes($_POST['courseID'])."','".addslashes($_POST['chapterID'])."','".$v_video."','".$vfileext1."','".addslashes($_POST['priceStatus'])."','".$image_file2."')");
}else {

$res=mysql_query("INSERT INTO `courseVideo`(`uiversityID`,`userID`,`courseID`,`chapterID`, `video`, `videoType`,`priceStatus`,`pdfupload`) VALUES('".$ui."','".$_SESSION['userid']."','".addslashes($_POST['courseID'])."','".addslashes($_POST['chapterID'])."','".$v_video."','".$vfileext1."','0','".$image_file2."')");
}
			if($res){
    ...
    <section class="my-profile-content no-padding container" id="my-profile">
      <div class="content-inside col-md-12">
        ...
        <div class="user-detail col-md-12">
          <div class="user-detail-bg grey-bg-wrapper">
              ...
              <ul class="user-detail-nav nav nav-tabs" role="tablist">
               <!-- <li role="presentation" class="active col-xs-6"><a href="#daftar-pelajaran" aria-controls="home" role="tab" data-toggle="tab"><h4>Create Chapter</h4></a></li>-->
                <li role="presentation" class="active col-xs-6"><a href="#profile-setting" aria-controls="profile" role="tab" data-toggle="tab"><h4>Add Video</h4></a></li>
              </ul>
              ...
              <div class="user-detail-content tab-content">
                ...
                <div role="tabpanel" class="tab-pane active profile-setting" id="profile-setting">
                 <div>
        ...
        <section class="content">
          ...
          <div class="box">
		  <?php 
		  $query=mysql_query("select * from tutorhighschool where tutorId='".$_SESSION['userid']."' and type='tutor'");
		  $res=mysql_fetch_object($query);
		  $ui=$res->universityID;
		  ?>
			...
			<select name="subjectID"  class="form-control" style="width:50%;" required>
                      ...
                      <label for="exampleInputPassword1">Chapter Name<span>*</span></label><br/>
					   ...
					   <input type="text" class="form-control" id="chapterName" name="chapterName" style="width:50%;"   placeholder=" Enter Chapter  Name ."required><br/>
                      ...
                      <label for="exampleInputPassword1">Chapter Number<span>*</span></label><br/>
					   ...
					   <input type="text" pattern="[1-9]+"  class="form-control" id="emailTutor" name="shortOrder" style="width:50%;" onBlur="emailvalidateC(this.value)" onFocus="if (this.value != ' ') {this.value = '';}"  placeholder=" Chapter Number ."required><br/>

					  </div>

                     <div class="go-red-button">
          <button type="submit"  name="addC">Create</button>
                    <br/>
                  </div>
...
<div class="go-red-button">
                  <button type="submit"  name="addV">Submit</button>
                  </div>
