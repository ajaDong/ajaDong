...
$res=mysql_query("INSERT INTO `tutorhighschool`(`firstnameTutor`, `emailTutor`, `passwordTutor`,`universityID`, `degreeTutor`,`type`,`statustutlogin`) VALUES ('".addslashes($_POST['firstnameStd'])."','".addslashes($_POST['emailStd'])."','".addslashes($_POST['passwordStd'])."','".addslashes($_POST['stuuiversity'])."','".addslashes($_POST['stuDegree'])."','student','1')");
$uid=mysql_insert_id();
...
$_SESSION['user-name']=$_POST['firstnameStd'];
$_SESSION['userid']=$uid;
$_SESSION['email']=$_POST['emailStd'];
$_SESSION['type']='student';
header("Refresh: 5; studentprofile.php");
}
else
{
 ...
 <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-8 form-custom">
          ...
          <div class="input-group">
			...
			<input type="email" class="sandeep" name="emailStd" placeholder="Your@e-mail.com" id="emailTutor" value="" onBlur="emailvalidate(this.value)" onFocus="if (this.value != ' ') {this.value = '';}"  required>
